...
describe "repeating_events/new" do
  before(:each) do
    assign(:repeating_event, stub_model(RepeatingEvent,
      :title => "MyString",
      :all_day => false,
  ...
  it "renders new repeating_event form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", repeating_events_path, "post" do
