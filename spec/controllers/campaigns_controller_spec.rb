  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved campaign as @campaign" do
        ...
        post :create, {:campaign => { "description" => "invalid value" }}, valid_session
        assigns(:campaign).should be_a_new(Campaign)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested campaign" do
        ...
        Campaign.any_instance.should_receive(:update).with({ "description" => "MyString" })
        put :update, {:id => campaign.to_param, :campaign => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the campaign as @campaign" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Campaign.any_instance.stub(:save).and_return(false)
        put :update, {:id => campaign.to_param, :campaign => { "description" => "invalid value" }}, valid_session
        assigns(:campaign).should eq(campaign)
      end
