...
describe EventsController do
  ...
  let(:valid_attributes) { { "description" => "MyString", :starts_at => "2/12/2012", :ends_at => "3/12/2012", :category_id => @category.id, :repetition_type => :none, :notes => "some random thoughts" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested event" do
        ...
        Event.any_instance.should_receive(:update).with({ "description" => "MyString" })
        put :update, {:id => event.to_param, :event => { "description" => "MyString" }}, valid_session
      end
